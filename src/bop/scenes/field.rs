use crate::bop::mechanism::item::Item;
use crate::bop::scenes::field::EventType::*;
...
impl FieldState {
    ...
    pub fn move_to(
        &mut self,
        rpg_shared_state: &mut CardGameSharedState,
...
impl Map {
    ...
    fn init_treasure_box_opened(&mut self, rpg_shared_state: &mut CardGameSharedState) {
    ...
    fn draw(&mut self, rpg_shared_state: &mut CardGameSharedState, elements: &mut SharedElements) {
